  ...
  return (
    <main className="min-h-screen bg-[#f8f8f9] text-[#1b2432]">
      ...
      <div className="mx-auto max-w-[1500px] px-5 py-8 lg:px-10">
        <div className="mb-7"><p className="mb-2 text-sm font-semibold text-[#3985ff]">Conciliación de cheques</p><h2 className="text-3xl font-semibold tracking-[-.025em] text-[#04102d]">Importar movimientos</h2><p className="mt-2 max-w-2xl text-sm leading-6 text-[#49505b]">Cargá el archivo generado para revisar sus registros antes de continuar con la conciliación.</p></div>
